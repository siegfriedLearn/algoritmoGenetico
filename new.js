...
let poblacionActualizada = encontrarVA(listadoJugadores)
...
function encontrarVA(jugadores) {
    let valorAdaptacion=0
      jugadores.forEach((jugador, index) => {
        ...
        jugadores[index].VA = parseFloat(valorAdaptacion.toFixed(4))
      });
    
      return jugadores
    }

let acumuladoProbabilidad = poblacionActualizada.reduce((acumulador, jugador)=> acumulador + jugador.VA, 0)
//console.log(acumuladoProbabilidad)

poblacionActualizada = encontrarProbabilidad(poblacionActualizada);

function encontrarProbabilidad(jugadores) {
    let probabilidad=0
      jugadores.forEach((jugador, index) => {
        probabilidad =jugador.VA/acumuladoProbabilidad
        jugadores[index].probabilidad = parseFloat(probabilidad.toFixed(4))
      });
    ...
    //Comprobación
// let otroAcum = poblacionActualizada.reduce((acumulador, jugador)=> acumulador + jugador.probabilidad, 0)
// console.log(otroAcum)

let q = [];
let acumulado = 0;
  
for (let i = 0; i < poblacionActualizada.length; i++) {
    acumulado += poblacionActualizada[i].probabilidad;
    q.push(acumulado);
  }

 // console.log(poblacionActualizada[0])
//   console.log(poblacionActualizada[1])

//   console.log(q[0])
//   console.log(q[1])

let w = parseFloat(Math.random().toFixed(4));
//console.log(w)